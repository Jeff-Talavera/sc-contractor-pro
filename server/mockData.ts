...
export const mockClients: Client[] = [
  ...
  {
    id: "client-5", organizationId: "org-1",
    parentClientId: "client-1",
    name: "Apex Steel & Frame LLC",
    contactName: "Carlos Reyes",
    contactEmail: "creyes@apexsteel.com",
    contactPhone: "(212) 555-0381",
    notes: "Steel subcontractor on One Vanderbilt Phase 2."
  },
];
...
export const mockSafetyReportSettings: SafetyReportSettings[] = [
  {
...
export const mockSafetyReports: SafetyReport[] = [
  {
    id: "sr-1", organizationId: "org-1", clientId: "client-1",
    periodType: "monthly", periodStart: "2026-03-01", periodEnd: "2026-03-31",
    totalManhours: 82000, totalHeadcount: 420, projectRiskTier: "High", newHirePercent: 8,
    recordableIncidents: 1, dartCases: 0, lostTimeIncidents: 0, emr: 0.87,
    oshaWillfulCitations: 0, oshaSeriousCitations: 0, oshaOtherCitations: 1, openWcClaims: 1,
    inspectionsCompleted: 18, inspectionsScheduled: 20,
    correctiveActionsClosed: 22, correctiveActionsOpened: 24, avgCorrectiveActionDays: 6,
    nearMissReports: 9, toolboxTalksCompleted: 19, toolboxTalksScheduled: 20,
    certifiedWorkforcePercent: 94, jhaCompliancePercent: 91, permitCompliancePercent: 97,
    overallScore: 87, incidentHistoryScore: 84, trainingComplianceScore: 97,
  ...
  {
    id: "sr-2", organizationId: "org-1", clientId: "client-1",
    periodType: "monthly", periodStart: "2026-02-01", periodEnd: "2026-02-28",
    totalManhours: 76000, totalHeadcount: 410, projectRiskTier: "High", newHirePercent: 10,
    recordableIncidents: 2, dartCases: 1, lostTimeIncidents: 0, emr: 0.87,
    oshaWillfulCitations: 0, oshaSeriousCitations: 1, oshaOtherCitations: 1, openWcClaims: 2,
    inspectionsCompleted: 15, inspectionsScheduled: 20,
    correctiveActionsClosed: 18, correctiveActionsOpened: 25, avgCorrectiveActionDays: 9,
    nearMissReports: 6, toolboxTalksCompleted: 17, toolboxTalksScheduled: 20,
    certifiedWorkforcePercent: 88, jhaCompliancePercent: 82, permitCompliancePercent: 90,
    overallScore: 72, incidentHistoryScore: 66, trainingComplianceScore: 85,
  ...
  {
    id: "sr-3", organizationId: "org-1", clientId: "client-1",
    periodType: "monthly", periodStart: "2026-01-01", periodEnd: "2026-01-31",
    totalManhours: 68000, totalHeadcount: 390, projectRiskTier: "High", newHirePercent: 14,
    recordableIncidents: 3, dartCases: 1, lostTimeIncidents: 1, emr: 0.87,
    oshaWillfulCitations: 0, oshaSeriousCitations: 1, oshaOtherCitations: 2, openWcClaims: 3,
    inspectionsCompleted: 12, inspectionsScheduled: 18,
    correctiveActionsClosed: 15, correctiveActionsOpened: 22, avgCorrectiveActionDays: 14,
    nearMissReports: 4, toolboxTalksCompleted: 14, toolboxTalksScheduled: 18,
    certifiedWorkforcePercent: 81, jhaCompliancePercent: 75, permitCompliancePercent: 84,
    overallScore: 61, incidentHistoryScore: 52, trainingComplianceScore: 78,
  ...
  {
    id: "sr-4", organizationId: "org-1", clientId: "client-1",
    periodType: "monthly", periodStart: "2025-12-01", periodEnd: "2025-12-31",
    totalManhours: 60000, totalHeadcount: 360, projectRiskTier: "High", newHirePercent: 16,
    recordableIncidents: 4, dartCases: 2, lostTimeIncidents: 1, emr: 0.87,
    oshaWillfulCitations: 0, oshaSeriousCitations: 2, oshaOtherCitations: 2, openWcClaims: 4,
    inspectionsCompleted: 10, inspectionsScheduled: 16,
    correctiveActionsClosed: 12, correctiveActionsOpened: 20, avgCorrectiveActionDays: 18,
    nearMissReports: 2, toolboxTalksCompleted: 11, toolboxTalksScheduled: 16,
    certifiedWorkforcePercent: 74, jhaCompliancePercent: 68, permitCompliancePercent: 79,
    overallScore: 50, incidentHistoryScore: 38, trainingComplianceScore: 71,
  ...
  {
    id: "sr-5", organizationId: "org-1", clientId: "client-2",
    periodType: "monthly", periodStart: "2026-03-01", periodEnd: "2026-03-31",
    totalManhours: 34000, totalHeadcount: 180, projectRiskTier: "Medium", newHirePercent: 5,
    recordableIncidents: 0, dartCases: 0, lostTimeIncidents: 0, emr: 0.75,
    oshaWillfulCitations: 0, oshaSeriousCitations: 0, oshaOtherCitations: 0, openWcClaims: 0,
    inspectionsCompleted: 9, inspectionsScheduled: 9,
    correctiveActionsClosed: 11, correctiveActionsOpened: 11, avgCorrectiveActionDays: 4,
    nearMissReports: 6, toolboxTalksCompleted: 9, toolboxTalksScheduled: 9,
    certifiedWorkforcePercent: 100, jhaCompliancePercent: 98, permitCompliancePercent: 100,
    overallScore: 97, incidentHistoryScore: 100, trainingComplianceScore: 99,
  ...
  {
    id: "sr-6", organizationId: "org-1", clientId: "client-2",
    periodType: "monthly", periodStart: "2026-02-01", periodEnd: "2026-02-28",
    totalManhours: 30000, totalHeadcount: 170, projectRiskTier: "Medium", newHirePercent: 6,
    recordableIncidents: 0, dartCases: 0, lostTimeIncidents: 0, emr: 0.75,
    oshaWillfulCitations: 0, oshaSeriousCitations: 0, oshaOtherCitations: 0, openWcClaims: 0,
    inspectionsCompleted: 8, inspectionsScheduled: 9,
    correctiveActionsClosed: 9, correctiveActionsOpened: 10, avgCorrectiveActionDays: 5,
    nearMissReports: 5, toolboxTalksCompleted: 8, toolboxTalksScheduled: 9,
    certifiedWorkforcePercent: 98, jhaCompliancePercent: 95, permitCompliancePercent: 98,
    overallScore: 93, incidentHistoryScore: 100, trainingComplianceScore: 96,
  ...
  {
    id: "sr-7", organizationId: "org-1", clientId: "client-3",
    periodType: "monthly", periodStart: "2026-03-01", periodEnd: "2026-03-31",
    totalManhours: 28000, totalHeadcount: 145, projectRiskTier: "High", newHirePercent: 12,
    recordableIncidents: 1, dartCases: 1, lostTimeIncidents: 0, emr: 1.12,
    oshaWillfulCitations: 0, oshaSeriousCitations: 1, oshaOtherCitations: 0, openWcClaims: 1,
    inspectionsCompleted: 7, inspectionsScheduled: 9,
    correctiveActionsClosed: 8, correctiveActionsOpened: 13, avgCorrectiveActionDays: 12,
    nearMissReports: 3, toolboxTalksCompleted: 7, toolboxTalksScheduled: 9,
    certifiedWorkforcePercent: 79, jhaCompliancePercent: 80, permitCompliancePercent: 85,
    overallScore: 66, incidentHistoryScore: 57, trainingComplianceScore: 79,
  ...
  {
    id: "sr-8", organizationId: "org-1", clientId: "client-4",
    periodType: "monthly", periodStart: "2026-03-01", periodEnd: "2026-03-31",
    totalManhours: 22000, totalHeadcount: 110, projectRiskTier: "Medium", newHirePercent: 4,
    recordableIncidents: 0, dartCases: 0, lostTimeIncidents: 0, emr: 0.82,
    oshaWillfulCitations: 0, oshaSeriousCitations: 0, oshaOtherCitations: 1, openWcClaims: 0,
    inspectionsCompleted: 6, inspectionsScheduled: 6,
    correctiveActionsClosed: 8, correctiveActionsOpened: 9, avgCorrectiveActionDays: 7,
    nearMissReports: 4, toolboxTalksCompleted: 6, toolboxTalksScheduled: 6,
    certifiedWorkforcePercent: 96, jhaCompliancePercent: 93, permitCompliancePercent: 95,
    overallScore: 90, incidentHistoryScore: 93, trainingComplianceScore: 98,
  ...
  {
    id: "sr-9", organizationId: "org-1", clientId: "client-5",
    periodType: "monthly", periodStart: "2026-03-01", periodEnd: "2026-03-31",
    totalManhours: 14000, totalHeadcount: 72, projectRiskTier: "High", newHirePercent: 20,
    recordableIncidents: 2, dartCases: 1, lostTimeIncidents: 1, emr: 1.35,
    oshaWillfulCitations: 0, oshaSeriousCitations: 1, oshaOtherCitations: 1, openWcClaims: 2,
    inspectionsCompleted: 4, inspectionsScheduled: 6,
    correctiveActionsClosed: 5, correctiveActionsOpened: 10, avgCorrectiveActionDays: 16,
    nearMissReports: 1, toolboxTalksCompleted: 4, toolboxTalksScheduled: 6,
    certifiedWorkforcePercent: 65, jhaCompliancePercent: 60, permitCompliancePercent: 72,
    overallScore: 42, incidentHistoryScore: 27, trainingComplianceScore: 62,
